...
# How many days go into the past
prediction_days = 60
...
model.add(LSTM(units = 50, return_sequences = True, input_shape = (x_train.shape[1], 1))) # Try out different numbers, more units more layers = longer training
...
# No clue, he said won't explain this stuff
